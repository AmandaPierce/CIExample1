...
protected Stack stack = null;
	...
	public void testPopOnEmptyStack() {
		...
		catch(AssertionError e)
		{
			...
			System.out.println(e + "Req1: false");
		}
		catch(Exception e)
		{	
			System.out.println("Req1: false. When the pop() function is called it tries to remove an item in the empty char elements array. The variable top is -1 and thus an ArrayIndexOutOfBoundsException error is thrown as pop() tries to return items[-1].");
		}
